...
Axiom balanceAddCoq0 : forall (uslim:Z), (0%Z <= uslim)%Z ->
  forall (usorig:(array uint256)) (usidx:Z) (usval:uint256)
  (usnew_val:uint256), ((to_int1 usnew_val) = ((to_int1 (get usorig
  usidx)) + (to_int1 usval))%Z) -> (((0%Z <= usidx)%Z /\
  (usidx < uslim)%Z) -> ((sum (set usorig usidx usnew_val) 0%Z
...
Axiom balanceAdd : forall (uslim:Z) (usorig:(array uint256)) (usidx:Z)
  (usval:uint256) (usnew_val:uint256),
  ((to_int1 usnew_val) = ((to_int1 (get usorig
  usidx)) + (to_int1 usval))%Z) -> (((0%Z <= usidx)%Z /\
  (usidx < uslim)%Z) -> ((sum (set usorig usidx usnew_val) 0%Z
...
Axiom small_elementCoqS : forall (x:Z), (0%Z <= x)%Z ->
  ((forall (usarray:(array uint256)) (usidx:Z), ((0%Z <= usidx)%Z /\
  (usidx <= x)%Z) -> ((to_int1 (get usarray usidx)) <= (sum usarray 0%Z
  (x + 1%Z)%Z))%Z) -> forall (usarray:(array uint256)) (usidx:Z),
  ((0%Z <= usidx)%Z /\ (usidx <= (x + 1%Z)%Z)%Z) -> ((to_int1 (get usarray
  usidx)) <= (sum usarray 0%Z ((x + 1%Z)%Z + 1%Z)%Z))%Z).

Axiom small_elementsCoq0 : forall (usarray:(array uint256)) (usidx:Z),
  ((0%Z <= usidx)%Z /\ (usidx <= 0%Z)%Z) -> ((to_int1 (get usarray
  usidx)) <= (sum usarray 0%Z (0%Z + 1%Z)%Z))%Z.

(* Why3 goal *)
Theorem small_elementsCoq : forall (uslim:Z), (0%Z <= uslim)%Z ->
  forall (usarray:(array uint256)) (usidx:Z), ((0%Z <= usidx)%Z /\
  (usidx <= uslim)%Z) -> ((to_int1 (get usarray usidx)) <= (sum usarray 0%Z
  (uslim + 1%Z)%Z))%Z.
(* Why3 intros uslim h1 usarray usidx (h2,h3). *)
Proof.
  apply (natlike_ind _ small_elementsCoq0 small_elementCoqS).
Qed.
